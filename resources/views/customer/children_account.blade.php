                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input required="" type="text" class="form-control"
                                                            name="childs_fullname" value="{{ old('childs_fullname') }}"
                                            ...
                                            <div class="col-sm-6 col-md-6 " style="margin-top: -10px">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <select name="childs_age" id="strategySelect"
                                                            class="form-control">
                                                            <option value="" disabled selected hidden>Childs Age
                                                            </option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <select name="duration" id="strategySelect"
                                                            class="form-control">
                                                            <option value="" disabled selected hidden>Duration
                                                            </option>
